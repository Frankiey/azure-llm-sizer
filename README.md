...
The results section includes a **How it works?** link that expands a short explanation of the memory estimation formula and shows the exact numbers used for the currently selected model.
